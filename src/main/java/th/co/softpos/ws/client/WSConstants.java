...
public class WSConstants {
    ...
    public static final String API_PRIVILEGE_TRUE_YOU_CARD = HOST_API + "/privilege/v1/terminals/{terminalId}/true-you-card";
    ...
    public static final String API_CAMPAIGN = HOST_API + "/campaign/v1/terminals/{terminalId}";
